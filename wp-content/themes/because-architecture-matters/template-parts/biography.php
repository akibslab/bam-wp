...
$author_info = get_the_author_meta('bam_write_by');
$facebook_url = get_the_author_meta('bam_facebook');
$twitter_url = get_the_author_meta('bam_twitter');
$linkedin_url = get_the_author_meta('bam_linkedin');
$instagram_url = get_the_author_meta('bam_instagram');
$bam_url = get_the_author_meta('bam_youtube');
$bam_write_by = get_the_author_meta('bam_write_by');
