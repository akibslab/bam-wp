 ...
 */
class TJ_Page_Heading extends Widget_Base {

  /**
   * Retrieve the widget name.
   */
  public function get_name() {
    return 'tj-page-heading';
  }
  ...
  public function get_title() {
    return __('TJ Page Heading', 'tjcore');
  }
  ...
  protected function register_controls() {
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'default' => 'center',
        'selectors' => [
          '{{WRAPPER}} .page-heading .page_heading_content' => 'text-align: {{VALUE}};'
        ]
      ]
    );
    $this->end_controls_section();
    ...
    $this->add_group_control(
      ...
      [
        ...
        'selector' => '{{WRAPPER}} .page-heading .page_heading_content',
      ]
    );
    $this->add_control(
      'title_color',
            ...
            <?php if ("layout-2" == $settings['tj_design_style']) : ?>
              <div class="page_heading_content style-2 haspadding">
                <div class="content_wrap">
                  ...
                  ?>
                    <p><?php echo tj_kses($settings['tj_page_description']); ?> </p>
                  <?php endif; ?>
                </div>
              </div>
            <?php else : ?>
              <div class="page_heading_content haspadding">
                <div class="content_wrap">
                  <?php
                  if (!empty($settings['tj_page_title'])) :
                    printf(
...
$widgets_manager->register(new TJ_Page_Heading());
