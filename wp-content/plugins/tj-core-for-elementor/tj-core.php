...
include_once(TJCORE_ADDONS_DIR . '/include/custom-post-projects.php');
include_once(TJCORE_ADDONS_DIR . '/include/custom-post-organizations.php');


/**
 * TJ Custom Widget
 */
include_once(TJCORE_WIDGET_PATH . '/tj-navigation.php');
// include_once(TJCORE_WIDGET_PATH . '/tj-info-widget.php');		
